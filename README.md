...
ทั้งสองอย่างใช้ข้อมูลจากทะเบียนอุปกรณ์ — ถ้าตั้งค่าให้ดึงจาก API ภายนอกแทน จะมีแต่ยอดรวม ดูรายตัวไม่ได้
...
เวลาที่ใช้เทียบคำนวณฝั่งเซิร์ฟเวอร์ทั้งหมด เพราะ `last_seen` ไม่มี timezone ติดมาด้วย
ถ้าให้เบราว์เซอร์คิดเองจะเพี้ยนทันทีที่ deploy อยู่คนละโซนเวลากับคนดู (เช่น Vercel เป็น UTC)
